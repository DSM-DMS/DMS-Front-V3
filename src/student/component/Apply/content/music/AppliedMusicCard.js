...
const AppliedMusicCard = ({ title, singer, author, id, selectedClass, onChangeCard }) => {
    return (
        <div className = {`unselectable apply--music--card ${selectedClass}`} onClick = {onChangeCard.bind(null, id)}>
